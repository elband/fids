    ...
    return (
        <FidsLayout title="FIDS - Check-in Counter">
            <div className="h-screen bg-black text-white font-sans select-none overflow-hidden flex flex-col">
                <header
                    className="relative w-full min-h-24 shrink-0 flex items-center justify-between gap-4 px-8 py-3 bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 overflow-hidden shadow-lg border-b-2 border-black bg-cover bg-center"
