...
export default function SingleGateDisplay({ identifier }: { identifier: string }) {
    ...
    if (gate?.status_gate === 'aktif') {
        bgColor = flight?.airline?.warna ? `bg-[${flight.airline.warna}] bg-opacity-20` : 'bg-teal-900/40';
        borderColor = flight?.airline?.warna ? `border-[${flight.airline.warna}]` : 'border-teal-500';
    }
            ...
            >
                ...
                <div className="flex-1 flex flex-col p-12 mt-40">
                    <div className="flex justify-between items-start mb-8">
                        <div>
                            <div className="text-3xl text-gray-400 tracking-[0.5em] font-medium uppercase mb-2">{t.boardingGateLabel[lang]}</div>
                            ...
                            <>
                                {flight ? (
                                    <div className="space-y-6">
                                        ...
                                        <div className="text-4xl text-yellow-400 tracking-widest font-bold">{t.destinationLabel[lang]}</div>
                    ...
                    <div className={`mt-auto h-32 rounded-2xl flex items-center justify-center border-4 ${borderColor} ${gate.status_gate === 'aktif' && flight ? 'bg-white/10' : 'bg-transparent border-transparent'}`}>
